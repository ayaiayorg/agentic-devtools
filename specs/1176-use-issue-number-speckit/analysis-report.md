...
|----------------|-----------|----------|-------|
| FR-001 | ✅ Yes | T010, T013, T015 | Covered: issue-number prefix for new directories. |
...
| FR-004 | ✅ Yes | T008, T010, T013, T015, T017 | Collision detection and new-directory creation covered. |
...
| FR-007 | ✅ Yes | T003, T004, T018, T019, T020, T021, T024, T025 | Bash autoincrement filtering across `generate-spec-from-issue.sh` and `create-new-feature.sh`. |
| FR-008 | ✅ Yes | T022, T023 | PowerShell autoincrement filtering in `create-new-feature.ps1`. |
| FR-009 | ✅ Yes | T003, T019, T024 | Covered: autoincrement ignores issue-numbered dirs. |
| FR-010 | ✅ Yes | T016 | SPEC_FILE derived from SPEC_DIR ensures consistency. |
| FR-011 | ✅ Yes | T005, T006, T007 | Fully covered with TDD cycle. |
| FR-012 | ✅ Yes | T009, T015 | Covered. |
| FR-013 | ✅ Yes | T032, T033, T034 | Workflow rerun idempotency: branch detection, force-push, test. |
| FR-014 | ✅ Yes | T035, T036 | `.specify` helper compatibility: `check_feature_branch` and `find_feature_dir_by_prefix` updates. |
| FR-015 | ✅ Yes | T011, T012, T014 | Safe reuse guard for 3-digit issue-number overlap: Source Issue verification before reuse. |
| US1 | ✅ Yes | T005, T006, T007, T010 | Maps to FR-011 and FR-001. |
| US2 | ✅ Yes | T008–T017 | Collision/reuse and new-directory creation covered. |
| US3 | ✅ Yes | T003, T004, T018–T025 | Well-covered. |
...
| SC-005 | ✅ Yes | T003, T018, T019, T024 | Covered by Bash filtering tests. |
| SC-006 | ✅ Yes | T022, T023 | Covered by PowerShell filtering tests. |
