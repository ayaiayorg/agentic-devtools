...
| urllib3 `InsecureRequestWarning` | Already suppressed in source (`jira/helpers.py`); add `filterwarnings` exemption as belt-and-suspenders |
...
**Known third-party exemptions discovered during audit** *(to be filled in)*:
