...
- [ ] CHK011 Functional requirements FR-001 through FR-007 are mapped to corresponding acceptance scenarios in
  User Stories 1–4 that validate their behavior; FR-004 currently lacks an explicit acceptance scenario
  for guard checks and should be added before proceeding.
  (FR-001→US1.1, FR-002→US2.1/US2.2, FR-003→US1.1, FR-004→(missing), FR-005→US4.1,
