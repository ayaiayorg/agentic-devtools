...
**Feature Branch**: `1587-event-driven-agent-session-trigger`  
**Created**: 2026-05-27  
**Status**: Draft  
...
- **FR-004**: The system MUST only trigger for PRs that belong to the same repository (not forks), are currently open (not closed or merged), and have not been excluded via the `ai-skip-entirely`
