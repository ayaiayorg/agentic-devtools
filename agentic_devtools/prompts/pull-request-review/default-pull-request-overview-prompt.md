# Pull Request Review Workflow - Pull Request Overview
...
**⚠️ IMPORTANT: You MUST run the command below before doing anything else. Do NOT review files manually.**

```bash
agdt-advance-workflow file-review
```

This command will load the first file for review with full diff context and review instructions.
