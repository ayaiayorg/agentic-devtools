...
from dfly_ai_helpers.cli.jira.update_commands import _build_update_payload, update_issue
...
class TestUpdateIssue:
    ...
    def test_requires_issue_key(self, mock_state_dir):
        ...
        with patch(
            "dfly_ai_helpers.cli.jira.update_commands.get_jira_value",
            return_value=None,
        ):
    ...
    def test_dry_run_mode(self, mock_state_dir, capsys):
        ...
        with patch(
            ...
            with patch(
                "dfly_ai_helpers.cli.jira.update_commands.is_dry_run",
                return_value=True,
            ):
                update_issue()
    ...
    def test_successful_update(self, mock_state_dir, capsys):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch("dfly_ai_helpers.cli.jira.update_commands._get_requests") as mock_requests:
                    mock_requests.return_value.put.return_value = mock_response
                    with patch(
                        "dfly_ai_helpers.cli.jira.update_commands.get_jira_base_url",
                        return_value="https://jira.example.com",
                    ):
                        with patch(
                            "dfly_ai_helpers.cli.jira.update_commands.get_jira_headers",
                            return_value={},
                        ):
                            with patch("dfly_ai_helpers.cli.jira.get_commands.get_issue"):
                                update_issue()
