...
from agentic_devtools.cli.workflows.commands import _ensure_bootstrap_identity
...
class TestEnsureBootstrapIdentityCalledBeforeClear:
    """Tests that _ensure_bootstrap_identity is called before clear_state_for_workflow_initiation
    in each initiate_*_workflow function."""
