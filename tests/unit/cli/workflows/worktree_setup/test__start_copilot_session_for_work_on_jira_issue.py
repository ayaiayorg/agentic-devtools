...
class TestCopilotSessionStartPromptWorkOnJiraIssue:
    ...
    def test_prompt_instructs_get_next_workflow_prompt(self):
        """The prompt must instruct the agent to hand off to the work-on-jira-issue agent."""
        assert "@agdt.work-on-jira-issue.initiate" in COPILOT_SESSION_START_PROMPT_WORK_ON_JIRA_ISSUE
