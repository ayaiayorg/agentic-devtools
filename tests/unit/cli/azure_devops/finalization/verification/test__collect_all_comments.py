...
class TestCollectAllComments:
    ...
    def test_collects_file_summaries_only(self):
        ...
        fs = EligibleComment(
            ...
            marker_data={}, current_content="content",
        )
    ...
    def test_collects_overall_summary(self):
        ...
        os_ = EligibleComment(
            ...
            marker_data={}, current_content="overall",
        )
    ...
    def test_collects_activity_log_entries(self):
        ...
        al = EligibleComment(
            ...
            marker_data={}, current_content="log",
        )
    ...
    def test_collects_all_types(self):
        ...
        fs = EligibleComment(
            thread_id=10, comment_id=1, marker_type="file-summary",
            marker_data={}, current_content="fs",
        )
        os_ = EligibleComment(
            thread_id=100, comment_id=1, marker_type="overall-summary",
            marker_data={}, current_content="os",
        )
        al = EligibleComment(
            thread_id=200, comment_id=2, marker_type="activity-log-entry",
            marker_data={}, current_content="al",
        )
