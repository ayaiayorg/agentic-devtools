...
class TestReadBranchTree:
    ...
    def test_nonexistent_branch_returns_empty_dict(self, mock_run):
        ...
        mock_run.return_value = MagicMock(returncode=128, stdout="", stderr="fatal: Needed a single revision")
    ...
    def test_raises_on_not_a_git_repo(self, mock_run):
        """read_branch_tree raises GitPlumbingError for 'not a git repository'."""
        mock_run.return_value = MagicMock(
            returncode=128,
            stdout="",
