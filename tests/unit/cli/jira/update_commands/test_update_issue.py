...
from agentic_devtools.cli.jira.update_commands import update_issue
...
class TestUpdateIssue:
    ...
    def test_dry_run_mode(self, mock_state_dir, capsys):
        ...
        with patch(
            ...
            with patch(
                "agentic_devtools.cli.jira.update_commands.is_dry_run",
                return_value=True,
            ):
                update_issue()
    ...
    def test_successful_update(self, mock_state_dir, capsys):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch("agentic_devtools.cli.jira.update_commands._get_requests") as mock_requests:
                    mock_requests.return_value.put.return_value = mock_response
                    with patch(
                        "agentic_devtools.cli.jira.update_commands.get_jira_base_url",
